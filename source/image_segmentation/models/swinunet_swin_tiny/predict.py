...
def main() -> None:
    ...
    parser.add_argument(
        "--checkpoint",
        default="source/image_segmentation/models/swinunet_swin_tiny/models/best_model.pth",
    )
    ...
    out_dir = Path("source/image_segmentation/models/swinunet_swin_tiny/results") / image_id
