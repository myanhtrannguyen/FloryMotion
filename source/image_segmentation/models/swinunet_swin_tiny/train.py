...
from source.image_segmentation.models.swinunet_swin_tiny.models.swinunet_swin_tiny import SwinUNetTiny
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train Swin U-Net with Swin Tiny backbone.")
    parser.add_argument(
        "--config",
        default="source/image_segmentation/models/swinunet_swin_tiny/models/config.yaml",
    )
